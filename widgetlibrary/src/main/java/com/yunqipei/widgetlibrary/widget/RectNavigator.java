...
//            canvas.drawCircle(pointF.x, pointF.y, mRadius, mPaint);
            canvas.drawRect(pointF.x - mRadius, pointF.y, pointF.x + mRadius, pointF.y + mStrokeHeight, mPaint);
        }
    }
...
//            canvas.drawCircle(mIndicatorX, (int) (getHeight() / 2.0f + 0.5f), mRadius, mPaint);
            canvas.drawRect(mIndicatorX - mRadius, (int) (getHeight() / 2.0f + 0.5f), mIndicatorX + mRadius, (int) (getHeight() / 2.0f + 0.5f) + mStrokeHeight, mPaint);
        }
    }
